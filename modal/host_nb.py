...
image = (
    ...
    .pip_install(
        ...
        index_url="https://download.pytorch.org/whl/cu121",  # ✅ correct placement
    )
    # --- Your main requirements (root or submodule) ---
    # 👇 change this path to where your submodule’s requirements.txt actually is
    .pip_install_from_requirements("cut3r/requirements.txt")
    # --- Additional dependencies like in your Colab cell ---
    .pip_install(
        "evo",
        "open3d",
        "gdown",
        # Optional: anything that was in your earlier list but not in requirements.txt
        "roma",
        "gradio",
        "matplotlib",
        "tqdm",
